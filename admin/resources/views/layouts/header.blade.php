<nav class="flex items-center justify-between lg:w-[92%] w-[94%] mx-auto py-5">
    ...
    <div id="list-menu" class="md:static absolute bg-primary md:min-h-fit min-[60vh] left-0 top-[-100%] md:w-auto w-full flex items-center px-5 md:pb-0 pb-3">
        <ul class="flex md:flex-row flex-col md:items-center md:gap-[4vw] gap-6">
            <li>
                <a href="{{ route('movies') }}" class="text-slate-50 hover:text-slate-400 duration-300">Movies</a>
            </li>
            <li>
                <a href="#" class="text-slate-50 hover:text-slate-400 duration-300">Posts</a>
            </li>
        </ul>
    </div>
    ...
    <script>
        function menu(open) {
            ...
            if (open) {
                ...
                list.classList.add('top-[7%]');
            } else {
                list.classList.remove('top-[7%]');
